...
export default function About() {
  ...
  return (
    <section
      id="about"
      className="relative pt-8 md:pt-12 pb-20 md:pb-28 px-6 overflow-hidden"
    >
        ...
        <div className="grid md:grid-cols-5 gap-8 md:gap-12 items-start">
          ...
          <div className="md:col-span-2 fade-in">
            <div className="relative">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-xl ring-1 ring-navy-800/10 bg-navy-50">
                {!imgLoaded && (
