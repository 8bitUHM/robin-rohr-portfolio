        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {articles.map((article, i) => (
              <div
                key={i}
                className={`fade-in fade-in-delay-${i + 1} group relative`}
              >
                ...
                <div className="relative bg-white rounded-3xl overflow-hidden shadow-sm border border-teal-800/5 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                  {/* Top accent bar */}
                  ...
                  <div className="p-7">
                    ...
                    <p className="text-teal-700/55 text-sm leading-relaxed mb-5">
                      {article.desc}
                    </p>
                    <a
                      href={article.file}
