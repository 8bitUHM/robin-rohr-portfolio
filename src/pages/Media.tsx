    ...
    <div className={`fade-in fade-in-delay-${index + 1} group relative h-full`}>
      ...
      <div className="relative bg-white rounded-3xl overflow-hidden shadow-sm border border-navy-800/5 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 h-full flex flex-col">
        ...
        <div className="aspect-[3/4] bg-gradient-to-b from-navy-50 to-ivory relative">
          {!loaded && (
            <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 z-10">
              ...
              <p className="text-navy-700/40 text-sm font-medium">
          ...
          >
            <div className="flex items-center justify-center h-full p-8 text-center">
              <div>
                ...
                <p className="text-navy-700/40 text-sm mb-5">
                ...
                <a
                  ...
                  className="inline-block px-6 py-2.5 bg-navy-800 text-ivory rounded-xl font-semibold text-sm hover:bg-navy-700 transition-colors shadow-sm"
                >
                  View Article
                </a>
              </div>
        ...
        <div className="p-7 flex flex-col flex-1">
          ...
          <p className="text-navy-700/55 text-sm leading-relaxed mb-5 flex-1">
            {article.desc}
          </p>
          <a
            href={article.file}
            target="_blank"
            rel="noopener noreferrer"
            className="group/link inline-flex items-center gap-2 text-navy-800 font-semibold text-sm hover:text-navy-600 transition-colors"
          >
            Open Full Article
            <svg
    ...
    <>
      ...
      <section className="relative pt-16 pb-10 md:pt-24 md:pb-14 px-6 text-center overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-10 left-1/4 w-72 h-72 bg-navy-200/10 rounded-full blur-3xl" />
        ...
        <div className="relative fade-in">
          ...
          <p className="text-navy-700/60 text-lg max-w-xl mx-auto">
